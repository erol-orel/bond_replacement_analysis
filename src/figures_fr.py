...
LBL = {"P0_AP5_benchmark": "AP5 (référence)", "P1_replace_33": "Remplacement 33 %",
       "P2_replace_66": "Remplacement 66 %", "P3_replace_100": "Remplacement 100 %"}
...
def main():
    ...
    for k, s in net.items():
        ax.plot(s, label=LBL[k], lw=2.4 if k == "P0_AP5_benchmark" else 1.5)
    ...
    for i, b in enumerate(["P0_AP5_benchmark", "P3_replace_100"]):
    ...
    fig, ax = plt.subplots(figsize=(9.5, 5))
    ax.plot(net["P0_AP5_benchmark"], label="AP5 (référence)", lw=2.4, color="black")
    ax.plot(net["P3_replace_100"], label="Panier naïf (100 %)", lw=1.5, color="tab:orange")
